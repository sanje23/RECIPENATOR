...
app = Flask(__name__, static_folder='/Project Recipenator/static', template_folder='/Project Recipenator/templates')
...
model_path = r"D:\Project Recipenator\mlmodel\trained_model.h5"
